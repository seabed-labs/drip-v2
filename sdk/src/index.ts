...
export class Drip {
  ...
  public async fetchGlobalConfig(key: PublicKey): Promise<GlobalConfigAccount> {
  ...
  public async initGlobalConfig(
    ...
    let txBuilder = this.program.methods
      ...
      .accounts({
        ...
        globalConfig: globalConfigPubkey ?? globalConfigKeypair.publicKey,
    ...
    return {
      ...
      globalConfigPubkey: globalConfigPubkey ?? globalConfigKeypair.publicKey,
    };
  }
}
