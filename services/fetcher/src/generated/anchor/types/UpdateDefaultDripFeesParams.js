...
exports.UpdateDefaultDripFeesParams = void 0
const bn_js_1 = __importDefault(require('bn.js')) // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require('@coral-xyz/borsh'))
class UpdateDefaultDripFeesParams {
    constructor(fields) {
    ...
    static toEncodable(fields) {
        return {
            newDefaultDripFeesBps: new bn_js_1.default(
...
exports.UpdateDefaultDripFeesParams = UpdateDefaultDripFeesParams
//# sourceMappingURL=UpdateDefaultDripFeesParams.js.map
