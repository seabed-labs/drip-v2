...
exports.UpdateDefaultPairDripFeesParams = void 0
const bn_js_1 = __importDefault(require('bn.js')) // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require('@coral-xyz/borsh'))
class UpdateDefaultPairDripFeesParams {
    constructor(fields) {
    ...
    static toEncodable(fields) {
        return {
            newDefaultPairDripFeesBps: new bn_js_1.default(
...
exports.UpdateDefaultPairDripFeesParams = UpdateDefaultPairDripFeesParams
//# sourceMappingURL=UpdateDefaultPairDripFeesParams.js.map
