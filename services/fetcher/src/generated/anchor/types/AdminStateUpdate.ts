...
export function fromDecoded(obj: any): types.AdminStateUpdateKind {
  ...
  if ("RemovePermission" in obj) {
    ...
    return new RemovePermission([types.AdminPermission.fromDecoded(val["_0"])])
  }
...
export function fromJSON(
  ...
  switch (obj.kind) {
    ...
    case "SetAdminAndResetPermissions": {
      return new SetAdminAndResetPermissions([new PublicKey(obj.value[0])])
    }
    case "ResetPermissions": {
      return new ResetPermissions()
    }
    case "AddPermission": {
      return new AddPermission([types.AdminPermission.fromJSON(obj.value[0])])
    }
