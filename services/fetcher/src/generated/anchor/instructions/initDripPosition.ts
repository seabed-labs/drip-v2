...
export class InitDripPosition {
  ...
  constructor(
    ...
    this.keys = [
      ...
      { pubkey: this.accounts.dripPosition, isSigner: true, isWritable: true },
      {
  ...
  build() {
    ...
    const len = layout.encode(
      {
        params: types.InitDripPositionParams.toEncodable(this.fields.params),
      },
      buffer
    )
  ...
  toAccountsJSON(): InitDripPositionAccountsJSON {
    return {
      ...
      associatedTokenProgram: this.accounts.associatedTokenProgram.toString(),
    }
  }
}
